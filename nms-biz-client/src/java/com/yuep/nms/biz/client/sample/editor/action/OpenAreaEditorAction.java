/*
 * $Id: OpenAreaEditorAction.java, 2010-3-31 ÏÂÎç05:30:42 aaron lee Exp $
 * 
 ...
 * 
 * @author aaron lee
 * created 2010-3-31 ÏÂÎç05:30:42
 * modified [who date description]
 * check [who date description]
 */
public class OpenAreaEditorAction extends AbstractXAction {
    private static final long serialVersionUID = 7616530137074964843L;

    /**
     * @param actionId
     */
    public OpenAreaEditorAction(String actionId) {
        super(actionId);
    }
