/*
 * $Id: OpenStringEditorAction.java, 2010-3-31 ÏÂÎç03:48:18 aaron lee Exp $
 * 
 ...
 * 
 * @author aaron lee
 * created 2010-3-31 ÏÂÎç03:48:18
 * modified [who date description]
 * check [who date description]
 */
public class OpenStringEditorAction extends AbstractXAction{
    private static final long serialVersionUID = 7616530137074964843L;

    /**
     * @param actionId
     */
    public OpenStringEditorAction(String actionId) {
        super(actionId);
    }
