...
public class DeleteManagedNodeAction extends DefaultPopupMenuAction{
	
	private static final long serialVersionUID = -6068179539945002414L;
	public DeleteManagedNodeAction(Boolean isMultiple, String actionId,
