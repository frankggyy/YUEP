/*
 * $Id: SampleMultipleTabNavigatorView2.java, 2010-3-30 下午01:25:16 aaron lee Exp $
 * 
...
/**
 * <p>
 * Title: SampleMultipleTabNavigatorView2
 * </p>
 * <p>
 * Description:
 * </p>
 * 
 * @author aaron lee
 * created 2010-3-30 下午01:25:16
 * modified [who date description]
 * check [who date description]
 */
public class SampleMultipleTabNavigatorView2 extends AbstractTabView<Object>{

    private static final long serialVersionUID = 902839270687874360L;
...
//        JLabel label2 = XSwingFactory.getLabel("第二列：");
//        numberField2 = XSwingFactory.getXNumberField("第二列：", true, 0, 100000);
//        JLabel label3 = XSwingFactory.getLabel("第三列：");
//        stringField3 = XSwingFactory.getXStringField("第三列：", true, 1, 64);
//        JLabel label4 = XSwingFactory.getLabel("第四列：");
//        stringField4 = XSwingFactory.getXStringField("第四列：", true, 1, 64);
...
//        contentPane.add(stringField4, "2,7,f,c");
        contentPane.add(label5, "1,3,f,c");
        contentPane.add(enumComboBox5, "2,3,f,c");
        contentPane.add(label6, "1,5,f,c");
        contentPane.add(numberField6, "2,5,f,c");
        contentPane.add(label7, "1,7,f,c");
        contentPane.add(checkBox7, "2,7,f,c");
