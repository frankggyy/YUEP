/*
 * $Id: OpenNumberEditorAction.java, 2010-3-31 ÏÂÎç03:48:01 aaron lee Exp $
 * 
 ...
 * 
 * @author aaron lee
 * created 2010-3-31 ÏÂÎç03:48:01
 * modified [who date description]
 * check [who date description]
 */
public class OpenNumberEditorAction extends AbstractXAction{
    private static final long serialVersionUID = 7616530137074964843L;

    /**
     * @param actionId
     */
    public OpenNumberEditorAction(String actionId) {
        super(actionId);
    }
