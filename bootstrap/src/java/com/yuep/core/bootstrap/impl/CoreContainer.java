/*
 * $Id: CoreContainer.java, 2011-2-25 上午10:11:41 sufeng Exp $
 * 
...
import com.yuep.core.bootstrap.def.module.ModuleConstants;
...
public class CoreContainer {
    ...
    private void start() {
        ...
        YuepLog.initLogging(fullPath, defaultLogName);
        Logger defaultLogger = YuepLog.getDefaultLogger();
