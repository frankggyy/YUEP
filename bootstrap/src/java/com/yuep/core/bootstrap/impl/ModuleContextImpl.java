/*
 * $Id: ModuleContextImpl.java, 2011-2-25 上午10:21:21 sufeng Exp $
 * 
...
import com.yuep.core.bootstrap.def.ModuleContextAware;
import com.yuep.core.bootstrap.def.module.Module;
import com.yuep.core.bootstrap.def.module.Module4Container;
import com.yuep.core.bootstrap.def.module.ModuleContext4Container;
import com.yuep.core.bootstrap.def.module.ModulePriority;
import com.yuep.core.bootstrap.impl.loader.ClassLoaderManager;
import com.yuep.core.bootstrap.impl.loader.ContainerClassLoader;
...
import com.yuep.core.bootstrap.impl.module.ModulePriorityImpl;
...
public final class ModuleContextImpl extends ModuleContext implements ModuleContext4Container{
    ...
    public void startModule(Module module) {
        ...
        // 注入Logger
        Logger logger=YuepLog.getLogger(module.getModuleName());
