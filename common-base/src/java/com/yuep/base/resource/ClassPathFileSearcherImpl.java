/*
 * $Id: ClassPathFileSearcherImpl.java, 2010-6-2 下午04:05:53 yangtao Exp $
 * 
...
public class ClassPathFileSearcherImpl implements ClassPathFileSearcher {
    ...
    /**
     * 
     * @see com.yuep.base.resource.ClassPathFileSearcher#search(java.lang.String)
     */
    @Override
    ...
    /**
     * 搜索资源
     * @see com.yuep.base.resource.ClassPathFileSearcher#searchResource(java.lang.String)
     */
    @Override
    ...
    private List<Resource> searchResource2(String matchPattern, ClassLoader classLoader) {
        ...
        try {
            ...
            resources = resourceResolver.getResources("classpath*:"+matchPattern);
            if(resources!=null){
                results.addAll(YuepObjectUtils.newArrayList(resources));
            }
            return results;
        } catch (Exception ex) {       
            throw new IllegalArgumentException(ex);
