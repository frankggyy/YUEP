/*
 * $Id: FtpUtils.java, 2010-11-12 上午11:46:42 sufeng Exp $
 * 
 ...
 */
package com.yuep.base.util.net.ftp;
...
public class FtpUtils {
    ...
    public static void downFile(String ip,String user,String password
        ...
        try{
            ...
            client.retrieveFile(dirFile[1], fileOutputStream);
        }catch(Exception ex){
            throw new YuepException(ex);
        }finally{
