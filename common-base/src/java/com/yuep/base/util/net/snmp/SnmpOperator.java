/*
 * $Id: SnmpOperator.java, 2010-11-12 上午11:40:47 sufeng Exp $
 * 
 ...
 */
package com.yuep.base.util.net.snmp;
...
import com.yuep.base.util.net.snmp.model.YuepSnmpException;
...
public class SnmpOperator {
    ...
    private SnmpVarBind[] getMultiOidValue(String... oids) {
        ...
        try {
            ...
            if (binds == null)
                throw new YuepSnmpException(YuepSnmpException.SBI_GET_ERROR, snmpSession.getErrorString()+","+SnmpOidUtil.getOidDisplayName(oids));
            if (snmpSession.getExceptionCode() == ErrorMessages.NOSUCHINSTANCEEXP)
                throw new YuepSnmpException(YuepSnmpException.SBI_NOSUCHINSTANCE, snmpSession.getErrorString()+","+SnmpOidUtil.getOidDisplayName(oids));
    ...
    public SnmpVarBind getSingleValue(String oid,int... timeoutInSecond) {
        ...
        try {
            ...
            if (var == null)
                throw new YuepSnmpException(YuepSnmpException.SBI_GET_ERROR, snmpSession.getErrorString()+","+oid);
            return var;
        } finally {
            snmpSession = null;
        }
    ...
    public void setValues(String[] oids, SnmpVar[] vars,int... timeoutInSecond) {
        ...
        try {
            if (oids.length > 0 && vars.length > 0) {
                ...
                if (binds == null)
                    throw new YuepSnmpException(YuepSnmpException.SBI_SET_ERROR, snmpSession.getErrorString()+","+SnmpOidUtil.getOidDisplayName(oids));
            }
        } catch (DataException e) {
            throw new YuepSnmpException(YuepSnmpException.SBI_SET_ERROR, e, snmpSession.getErrorString()+","+SnmpOidUtil.getOidDisplayName(oids));
        } finally {
            snmpSession = null;
        }
    }
    ...
    public SnmpVarBind[][] getAllTableValues_Bulk(String entryOid,int... timeouts) {
        ...
        try {
            ...
            while (true) {
                ...
                if (binds == null)
                    throw new YuepSnmpException(YuepSnmpException.SBI_GET_ERROR, snmpSession.getErrorString()+",table:"+entryOid);
    ...
    public SnmpVarBind[] getTableColumnValues_Bulk(String columnOid,int... timeouts) {
        ...
        try {
            ...
            while (true) {
                ...
                SnmpVarBind[][] binds = snmpSession.snmpGetBulkVariableBindings();                
                if (binds == null)
                    throw new YuepSnmpException(YuepSnmpException.SBI_GET_ERROR, snmpSession.getErrorString()+",column:"+columnOid);
