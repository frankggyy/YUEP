/*
 * $Id: RemoteInvocationFacadeImpl.java, 2011-1-30 下午04:37:55 sufeng Exp $
 * 
...
import com.yuep.core.proxy.impl.ProxyFacadeRemoteServiceManager;
...
public class RemoteInvocationFacadeImpl implements RemoteInvocationFacade{
    ...
    private Session createSession(Object[] args){
        ...
        try {
            ...
            throw new YuepException("getClientHost failed," + ExceptionUtils.getCommonExceptionInfo(ex));
        }
