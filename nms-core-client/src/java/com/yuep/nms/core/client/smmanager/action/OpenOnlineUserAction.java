/*
 * $Id: OpenOnlineUserAction.java, 2011-5-5 ÏÂÎç03:08:51 aaron Exp $
 * 
 ...
 * 
 * @author aaron
 * created 2011-5-5 ÏÂÎç03:08:51
 * modified [who date description]
 * check [who date description]
 */
public class OpenOnlineUserAction extends AbstractMainMenuAction {

    private static final long serialVersionUID = 8433253520391591707L;

    public OpenOnlineUserAction(String actionId) {
        super(actionId);
    }
    ...
    protected void updateUi(Object... objs) {
        ...
        Element node = smManagerController.getClientView().getNodeById("smmanager.onlineuser");
