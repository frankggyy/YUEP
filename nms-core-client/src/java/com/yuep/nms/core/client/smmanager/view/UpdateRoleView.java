/*
 * $Id: UpdateRoleView.java, 2011-4-13 上午09:07:59 WangRui Exp $
 * 
...
import com.yuep.nms.core.client.smmanager.action.UpdateRoleAction;
 ...
 * 
 * @author WangRui
 * created 2011-4-13 上午09:07:59
 * modified [who date description]
 * check [who date description]
 */
public class UpdateRoleView extends AbstractValidateView<Object> {
    private static final long serialVersionUID = -1698729511567331494L;
    ...
    protected void initializeData(List<Object> data) {
        ...
        roleNameEditor.setText(role.getRoleName());
        roleNameEditor.setEditable(false);
        descriptionEditor.setText(role.getDescription());
    }
    ...
    protected <V, M> void addButtonListener(ClientController<Object, V, M> controller) {
        UpdateRoleAction updateAction = new UpdateRoleAction(false, "", controller);
        okButton.addActionListener(updateAction);
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) {
                    ...
                    if (moPerms == null || moPerms.size() < 1)
                        ...
                        controller.initData(permGroupList, false);
