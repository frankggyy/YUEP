/*
 * $Id: XTableLayout.java, 2010-3-26 下午04:12:57 aaron lee Exp $
 * 
...
public class XTableLayout implements LayoutManager2, VTabLayoutConstants {
    ...
    protected static class Entry extends VTabLayoutConstraints {
        ...
        public boolean equals(Object object) {
            if(object==null)
                return false;
            if(Component.class.isAssignableFrom(object.getClass())){  //object是componet的子类
     ...
     *            <br>
     *            <br>组件如何放入表格中：
     *            <br>panel.add(ipAddrTextField, "1,1,3,f"); //2行，2列，列跨2-4列，行填满
     *            <br>
